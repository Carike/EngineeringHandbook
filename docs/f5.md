...
Here are some guidelines to perform a Big-ip upgrade:

1. Preparation:
  1. Check version compatibility, review release notes, and ensure license validity.
  1. Backup configuration (create a UCS file).
  1. Confirm there is enough disk space for the upgrade.
  1. Plan a maintenance window for the upgrade.
1. Perform the Upgrade:
  1. Download and upload the new software image.
  1. Install the new version on a new boot volume.
  1. Apply any necessary hotfixes.
1. Reboot the System:
  1. Reboot into the newly installed partition.
1. Post-Upgrade Tasks:
  1. Verify the software version and system functionality.
  1. Test all configurations.
  1. Monitor system performance for any issues.
1. Rollback (if necessary):
  1. Reboot from the old partition if needed.

This ensures a safe and efficient BIG-IP upgrade.

## Useful links

* https://my.f5.com/manage/s/article/K9970
* https://my.f5.com/manage/s/article/K12201527
* [Automating BIGIP with Terraform](https://www.youtube.com/watch?v=cePyP_nBBmc&list=PLz46SWmvZj2T4PLyimY1d64-T_w_jBAGu&index=8)
* [Wednesday Webinars](https://www.youtube.com/playlist?list=PLz46SWmvZj2T4PLyimY1d64-T_w_jBAGu)

## Learning TMSH

* [F5 BIG-IP Administrative Scripts: Monitoring, Performance, and Troubleshooting Tools](https://github.com/CarlB-dev/f5_bash_tmsh_collection/tree/main/system_usage)
  * [BIG-IP usage monitoring script collection](https://www.linkedin.com/pulse/big-ip-usage-monitoring-script-collection-carl-brothers-ykjde/) article

## Monitoring F5

### Zabbix
- [f5_bigip_snmp](https://git.zabbix.com/projects/ZBX/repos/zabbix/browse/templates/net/f5_bigip_snmp?at=refs%2Ftags%2F7.2.4)

### Grafana
- https://grafana.com/grafana/dashboards/13236-big-ip-f5/
- https://grafana.com/docs/grafana-cloud/monitor-infrastructure/integrations/integration-reference/integration-f5-bigip/
- https://grafana.com/solutions/f5-bigip/monitor/
- https://grafana.com/grafana/dashboards/19135-f5-big-ip-dashboard/
- https://grafana.com/grafana/dashboards/12089-telemetry-streaming-statsd-dashboard-for-f5-big-ip/
- https://grafana.com/grafana/dashboards/19086-big-ip-f5/